...
TEST_DEVICE_PROFILES = {
	...
	'unifi-ac-lite': {
		'host_attrs': {
			'reachable': True,
			'descr': 'UAP-AC-Lite 6.6.77.15402',
			'contact': 'root@localhost',
			'location': 'FL04',
			'hostname': 'FL04Wifi',
			'mac': 'FC:EC:DA:31:1B:F5',
			'manufacturer': 'Ubiquiti Networks Inc.',
			'model': 'UAP-AC-Lite',
			'object_id': '1.3.6.1.4.1.41112',
			'os_name': 'UniFi OS',
			'os_version': '6.6.77.15402',
			'os_date': None,
			'serial': None,
			'type': 'Wifi',
		...
		'ports': {
			...
			'5': {
				...
				'mtu': 1500,
				'speed': 0,
				'bytes_rx': 13509613536,
				'bytes_tx': 68893560441,
				'errors_rx': 0,
				'errors_tx': 0,
				'ips': [],
			},
	...
	'unifi-ac-pro': {
		'host_attrs': {
			'reachable': True,
			'descr': 'UAP-AC-Pro-Gen2 6.6.77.15402',
			'contact': 'root@localhost',
			'location': 'FL02 Wes',
			'hostname': 'FL02-2Wifi',
			'mac': '80:2A:A8:53:A0:C2',
			'manufacturer': 'Ubiquiti Networks Inc.',
	...
	'unifi-udm-pro': {
		'host_attrs': {
			'reachable': True,
			'descr': 'Ubiquiti UniFi UDM-Pro 4.1.22 Linux 4.19.152 al324',
			'contact': 'Charlie Powell',
			'location': 'FL02 Server Room',
			'hostname': '175otp',
			'mac': 'E6:38:83:32:66:79',
			'manufacturer': 'Ubiquiti Networks Inc.',
			'model': 'UDM-Pro',
		...
		'ports': {
			...
			'40': {
				...
				'mtu': 1500,
				'speed': 1000000000,
				'bytes_rx': 43251791021379,
				'bytes_tx': 793891098904,
				'errors_rx': 0,
				'errors_tx': 0,
				'ips': [],
			},
	...
	'unifi-us8-60w': {
		'host_attrs': {
			'reachable': True,
			'descr': 'US-8-60W, 7.0.50.15613, Linux 3.6.5',
			'contact': None,
			'location': None,
			'hostname': 'US-8-60W',
			'mac': 'F0:9F:C2:18:4C:28',
			'manufacturer': 'Ubiquiti Networks Inc.',
			'model': 'US-8-60W',
			'object_id': '1.3.6.1.4.1.4413',
			'os_name': 'UniFi OS',
			'os_version': '7.0.50.15613',
			'os_date': None,
			'serial': 'f09fc2184c27',
			'type': 'Switch',
			'gateway': '10.200.0.1',
		...
		'ports': {
			'1': {
				...
				'mtu': 1518,
				'speed': 1000000000,
				'bytes_rx': 10170100520892,
				'bytes_tx': 1618369087709,
				'errors_rx': 0,
				'errors_tx': 0,
				'ips': [],
			},
	...
	'unifi-usw24poe': {
		'host_attrs': {
			'reachable': True,
			'descr': 'Linux UBNT 3.18.24 #0 Thu Aug 30 12:10:54 2018 mips',
			'contact': 'Default',
			'location': 'FL02 Maintenance Room',
			'hostname': 'FL02Switch',
			'mac': '6C:63:F8:22:89:4F',
			'manufacturer': 'Ubiquiti Networks Inc.',
			'model': None,
			'object_id': '1.3.6.1.4.1.8072.3.2.10',
			'os_name': 'UniFi OS',
	...
	'unifi-uxg-lite': {
		'host_attrs': {
			'reachable': True,
			'descr': 'Ubiquiti UniFi UXG-Lite 4.1.13 Linux 5.4.213 ipq5018',
			'contact': 'contact',
			'location': 'location',
			'hostname': 'UXG-Lite',
			'mac': '9E:05:D6:51:8B:5A',
			'manufacturer': 'Ubiquiti Networks Inc.',
			'model': 'UXG-Lite',
			'object_id': '1.3.6.1.4.1.8072.3.2.10',
			'os_name': 'UniFi OS',
	...
	'vivotek-fd8161': {
		'host_attrs': {
			'reachable': True,
			'descr': 'H.264 Mega-Pixel Network Camera',
			'contact': ' ',
			'location': ' ',
			'hostname': 'H.264 Mega-Pixel Network Camera',
			'mac': '00:02:D1:13:89:D1',
			'manufacturer': 'Vivotek Inc.',
			'model': None,
			'object_id': '1.3.6.1.4.1.23465',
			'os_name': None,
			'os_version': None,
			'os_date': None,
			'serial': None,
